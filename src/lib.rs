...
fn remove_prefix_words(list: Vec<String>) -> Vec<String> {
    ...
    list_without_prefix_words.retain(|potential_prefix_word| {
        ...
        // prefix word. So we want to retain it for the list_without_prefix_words. return true to the
        // retain
        true
    });
...
fn _find_prefix_words_to_remove(list: &[String]) -> Vec<usize> {
...
fn _find_reject_words_to_remove(list: &[String], reject_list: &[String]) -> Vec<usize> {
...
fn _remove_by_position(positions_to_remove: Vec<usize>, list: Vec<String>) -> Vec<String> {
