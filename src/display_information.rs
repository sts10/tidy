...
/// Calculates the "efficiency" of the words in the list.
/// Basically it's the bits of entropy generated by the AVERAGE
/// character. Thus it is different from assumed_entropy_per_word,
/// which you can think of as the "worst case scenario".
